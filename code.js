...
function showSelectedOperator(){
    ...
    if (operator_value == "+"){
        document.getElementById("plusOp").style.backgroundColor  = "#FF0000";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#FF0000";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#FF0000";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#FF0000";
    }
}
...
function keyReleased(e){
    ...
    if (e.key == "Backspace"){
        document.getElementById("backspace_btn").style.backgroundColor  = "#66666";
    }
}